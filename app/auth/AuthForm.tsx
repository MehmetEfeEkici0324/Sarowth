  ...
  return (
    <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.05] p-6 shadow-[0_0_60px_rgba(16,185,129,0.08)] backdrop-blur-xl">
      ...
      <p className="mt-3 text-center text-sm leading-6 text-slate-400">
        {isSignup ? "E-posta ve şifreni gir. Kaydını tamamlamak için e-postana 6 haneli doğrulama kodu göndereceğiz." : "Kayıt sırasında doğruladığın e-posta ve şifreyle giriş yap."}
      </p>
