  ...
  return (
    <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.05] p-6 shadow-[0_0_60px_rgba(16,185,129,0.08)] backdrop-blur-xl">
      ...
      <p className="mt-3 text-center text-sm leading-6 text-slate-400">
        <span className="text-slate-200">{email}</span> adresine tek kullanımlık bir doğrulama kodu gönderdik. Doğruladıktan sonra şifrenle giriş yapabilirsin.
      </p>
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        E-posta yanlış mı? <a href={flow === "signup" ? "/signup" : "/login"} className="font-semibold text-emerald-300 hover:text-emerald-200">Baştan başla</a>
      </p>
